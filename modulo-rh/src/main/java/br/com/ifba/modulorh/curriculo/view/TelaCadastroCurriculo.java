...
public class TelaCadastroCurriculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblExperienciaProfissional = new javax.swing.JLabel();
        ...
        pnlTextFields.add(lblEndereco, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 80, 20));

        lblTelefone.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblTelefone.setText("Telefone");
        pnlTextFields.add(lblTelefone, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 80, 20));

        lblVaga.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblVaga.setText("Vaga");
        pnlTextFields.add(lblVaga, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 80, 20));

        lblFormacaoAcademica.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblFormacaoAcademica.setText("Formação acadêmica");
        pnlTextFields.add(lblFormacaoAcademica, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 160, 20));

        lblExperienciaProfissional.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblExperienciaProfissional.setText("Experiência profissional");
        pnlTextFields.add(lblExperienciaProfissional, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 180, 20));
        ...
        txtFormacaoAcademica.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtFormacaoAcademicaKeyPressed(evt);
            }
        });
        ...
        txtExperienciaProfissional.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtExperienciaProfissionalKeyPressed(evt);
            }
        });
        ...
        pnlTextFields.add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 80, 20));
    ...
    private void txtFormacaoAcademicaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFormacaoAcademicaKeyPressed
        if(txtFormacaoAcademica.getText().trim().isEmpty()){
            lblFormacaoAcademica.setVisible(true);
        }else{
            lblFormacaoAcademica.setVisible(false);
        }
    }//GEN-LAST:event_txtFormacaoAcademicaKeyPressed

    private void txtExperienciaProfissionalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtExperienciaProfissionalKeyPressed
        if(txtExperienciaProfissional.getText().trim().isEmpty()){
            lblExperienciaProfissional.setVisible(true);
        }else{
            lblExperienciaProfissional.setVisible(false);
        }
    }//GEN-LAST:event_txtExperienciaProfissionalKeyPressed
    ...
    private javax.swing.JLabel lblExperienciaProfissional;
